...
const Footer = () => (
  <Container>
    <footer className="bt b--black-10 mt5 pt4 pb4">
      <div className="flex flex-column-reverse flex-row-ns items-center">
        <div className="w-50-ns mt3 mt0-ns mb0-ns center">© {new Date().getFullYear()}, <span className="fw6">Лафче</span></div>
        ...
        <div className="w-50-ns center">
          ...
          <a href="https://www.instagram.com/lafche_club/" className="fr mr3" title="Lafche Instagram" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.youtube.com/channel/UC2lnx3KBS4T_YuT5HqAjdPA" className="fr mr3" title="Lafche Youtube" target="_blank" rel="noopener noreferrer">
