...
const EventsPage = ({ data }) => (
  <Layout>
    <SEO title="Събития" description="Събитията ще са в онлайн формат, веднъж месечно, при неформална обстановка. Темите, които ще се обсъждат, не са от строго определени сфери - oт садене на картофи, през програмиране, до пчеларство." />
